...
DECLARATIVE_RUNNER_TAG="0.1.64"   # 0.1.62: rebuilds sdk 0.2.5 (MCP arg-marshaling fix — drop omitted-optional None args; fixes Tavily). 0.1.61/0.1.59: prior (matches values.yaml declarativeRunnerTag)
