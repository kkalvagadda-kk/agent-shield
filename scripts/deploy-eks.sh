...
MCP_PROXY_TAG="0.1.4"   # 0.1.0: NEW centralized MCP wire client (tool discovery + governed tool calls). Dockerfile COPYs scripts/e2e/fixtures/stub_mcp_server.py → REPO-ROOT build context.
