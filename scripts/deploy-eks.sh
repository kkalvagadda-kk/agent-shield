...
EVENT_GATEWAY_TAG="0.1.5"   # 0.1.5: read-side status filter in webhook_auth._TRIGGER_SQL   # 0.1.4: Decision 30 gateway cutover — webhook_auth.py resolves applications+artifact_role_grants (not webhook_clients) — matches values.yaml
